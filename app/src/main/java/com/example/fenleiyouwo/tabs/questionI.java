...
public class questionI {
    ...
    //构造函数
    public questionI(String title, String content, String picurl,String articalurl){
        this.title=title;
    ...
    //返回一个列表
    public static List<questionI> getAllQuestions(){
        List<questionI> questions = new ArrayList<questionI>();
        questions.add(new questionI("大创项目介绍 | 校园内垃圾分类回收问题研究","本项目将在大创展正式和大家见面，欢迎大家持续关注我们！" , "http://m.qpic.cn/psc?/V51o6AfO138S3m3lNdc10hOSZE4VGVwk/45NBuzDIW489QBoVep5mcWZNvbByeauNY*34l.pm7A1WKT3axiRTs3gl95GzJtq1U.lEo2ZMUlv8i87oVY*YrJHPb88Ipv43WcPAMn7wQZQ!/b&bo=2wOaAdsDmgEBGT4!&rf=viewer_4&t=5","https://mp.weixin.qq.com/s/w-R3Ee-JThB86g9qXRMfDw"));
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    URL url = new URL("http://123.60.15.193//rubbish/index.php/Home/Article/question_all");
                    ...
                    try {
                        ...
                        for (int i = jsonArray.length()-1; i >=0; i--) {
                            ...
                            questions.add(new questionI(title, context, pic_url,articleUrl));
                        }
